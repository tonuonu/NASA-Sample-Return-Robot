...
*            : 1.0A  (2011-08-04)  [Hardware Manual Revision : 1.00]
*            : 1.2D  (2012-06-17)  [Hardware Manual Revision : 1.20]
*
* NOTE       : THIS IS A TYPICAL EXAMPLE.
*
* Copyright (C) 2012(2010) Renesas Electronics Corporation
...
#define	AD		(*(volatile struct st_ad     __sfr __evenaccess *)0x89800)
...
#define	FLASH	(*(volatile struct st_flash  __sfr __evenaccess *)0x8C296)
#define	ICU		(*(volatile struct st_icu    __sfr __evenaccess *)0x87000)
#define	IEB		(*(volatile struct st_ieb    __sfr __evenaccess *)0x8A800)
...
#define	RIIC0	(*(volatile struct st_riic0  __sfr __evenaccess *)0x88300)
#define	RIIC1	(*(volatile struct st_riic1  __sfr __evenaccess *)0x88320)
#define	RIIC2	(*(volatile struct st_riic1  __sfr __evenaccess *)0x88340)
#define	RIIC3	(*(volatile struct st_riic1  __sfr __evenaccess *)0x88360)
#define	RSPI0	(*(volatile struct st_rspi   __sfr __evenaccess *)0x88380)
#define	RSPI1	(*(volatile struct st_rspi   __sfr __evenaccess *)0x883A0)
#define	RSPI2	(*(volatile struct st_rspi   __sfr __evenaccess *)0x883C0)
...
#define	SCI7	(*(volatile struct st_sci0   __sfr __evenaccess *)0x8A0E0)
#define	SCI8	(*(volatile struct st_sci0   __sfr __evenaccess *)0x8A100)
#define	SCI9	(*(volatile struct st_sci0   __sfr __evenaccess *)0x8A120)
#define	SCI10	(*(volatile struct st_sci0   __sfr __evenaccess *)0x8A140)
#define	SCI11	(*(volatile struct st_sci0   __sfr __evenaccess *)0x8A160)
#define	SCI12	(*(volatile struct st_sci12  __sfr __evenaccess *)0x8B300)
#define	SMCI0	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A000)
#define	SMCI1	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A020)
#define	SMCI2	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A040)
#define	SMCI3	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A060)
#define	SMCI4	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A080)
#define	SMCI5	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A0A0)
#define	SMCI6	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A0C0)
#define	SMCI7	(*(volatile struct st_smci7  __sfr __evenaccess *)0x8A0E0)
#define	SMCI8	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A100)
#define	SMCI9	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A120)
#define	SMCI10	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A140)
#define	SMCI11	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8A160)
#define	SMCI12	(*(volatile struct st_smci0  __sfr __evenaccess *)0x8B300)
...
#define	TPU6	(*(volatile struct st_tpu0   __sfr __evenaccess *)0x88178)
#define	TPU7	(*(volatile struct st_tpu1   __sfr __evenaccess *)0x88178)
#define	TPU8	(*(volatile struct st_tpu2   __sfr __evenaccess *)0x8817A)
#define	TPU9	(*(volatile struct st_tpu3   __sfr __evenaccess *)0x8817A)
#define	TPU10	(*(volatile struct st_tpu4   __sfr __evenaccess *)0x8817C)
#define	TPU11	(*(volatile struct st_tpu5   __sfr __evenaccess *)0x8817C)
#define	TPUA	(*(volatile struct st_tpua   __sfr __evenaccess *)0x88100)
#define	TPUB	(*(volatile struct st_tpub   __sfr __evenaccess *)0x88170)
