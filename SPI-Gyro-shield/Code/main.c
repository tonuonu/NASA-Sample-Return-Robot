...
set_acceleration(unsigned char motor_idx) {
    ...
    u0tb=u6tb=u3tb=u4tb=CMD_ACCELERATION | motor_idx;
    complete_tx();

    u0tb=u6tb=u3tb=u4tb=acceleration[0];
    complete_tx();

    u0tb=u6tb=u3tb=u4tb=acceleration[1];
    complete_tx();
...
set_speed(unsigned char motor_idx) {
    ...
    u0tb=u6tb=u3tb=u4tb=CMD_SPEED | motor_idx;
    complete_tx();
